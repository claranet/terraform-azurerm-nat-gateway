...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) 99685e4

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 3c85811
* **deps:** update dependency tflint to v0.64.0 627c1d1
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template 50baf6c
* **v9:** 🐛 synchronize common files and docs 2b1f830

## 8.0.6 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug 1b7afe5

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 ee06e4e
* **deps:** update dependency opentofu to v1.12.2 b2043bc
* **deps:** update dependency opentofu to v1.12.3 be02ca1
* **deps:** update dependency opentofu to v1.12.4 f647857
* **deps:** update dependency tflint to v0.63.1 6d1b089
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 69bfd30
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 77b6718

## 8.0.5 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 649e837

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu e050461
* **deps:** update dependency opentofu to v1.11.7 0f944ff
* **deps:** update dependency opentofu to v1.12.0 c88b07d
* **deps:** update dependency terraform-docs to v0.23.0 44dc811
* **deps:** update dependency terraform-docs to v0.24.0 48b4668
* **deps:** update dependency tflint to v0.62.1 cd21c5a
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 2721b2b
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 17168c8
* **deps:** update tools dc3b19c
* **pre-commit:** 🔧 move to prek 6d599a5
* **tfdocs:** bump tfdocs to v0.22 🔧 283be11

## 8.0.4 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 163c403

### Code Refactoring

* update module structure and Github actions 👷 363e834

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 63c36d6
* **deps:** 🔗 bump tflint rules version de7253c
* **deps:** update dependency trivy to v0.69.2 53541b1
* **deps:** update dependency trivy to v0.69.3 a0f35c4
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 c5534aa
